...
nohup java -Dfile.encoding=UTF-8 -cp $JAVA_HOME/lib/*:$DAVINCI3_HOME/lib/*:/opt/davinci/lib/davinci-server_3.01-0.3.1-SNAPSHOT.jar edp.DavinciServerApplication > $LOG_PATH  2>&1 &
